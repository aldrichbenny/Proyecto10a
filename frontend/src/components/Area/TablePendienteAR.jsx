        ...
        axios.get('http://127.0.0.1:8000/api/Area/')
            .then(response => {
                ...
                if (area) {
                    ...
                    if (areaName === 'Cut') {
                        apiUrl = 'http://127.0.0.1:8000/api/Pedido/estado/CUT-OFF-PENDING/';
                    } else if (areaName === 'Packaging') {
                        apiUrl = 'http://127.0.0.1:8000/api/Pedido/estado/PACKAGING-PENDING/';
                    }
                            ...
                            <tr key={index}>
                                ...
                                <td>
                                    <Button 
                                        ...
                                        onClick={() => {
                                            navigate('/pendienteDetailsAR', { state: { clienteId: row.clienteId, orderId: row.id_pedido, fechaR: row.fecha, horaR: row.hora} });
                                        }}                                    >
                                        Ver
                                    </Button>
                                </td>
