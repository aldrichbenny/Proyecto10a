    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nombre_rol', models.CharField(choices=[('Cliente', 'Cliente'), ('JefedeArea', 'Jefe de Área'), ('Administrador', 'Administrador')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_stock', models.ForeignKey(db_column='id_stock', on_delete=django.db.models.deletion.CASCADE, to='api.stock')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'constraints': [models.CheckConstraint(condition=models.Q(('estado_seguimiento__in', ['ENREVISION', 'CORTE', 'EMBALAJE', 'ENVIADO'])), name='historial_estado_solicitud')],
            },
        ),
        ...
        migrations.AddConstraint(
            model_name='pedido',
            constraint=models.CheckConstraint(condition=models.Q(('estado_pedido__in', ['ENREVISION', 'CORTE', 'EMBALAJE', 'ENVIADO'])), name='pedido_estado_solicitud'),
        ),
        migrations.AddConstraint(
        ...
        migrations.AddConstraint(
            model_name='solicitud',
            constraint=models.CheckConstraint(condition=models.Q(('estado_solicitud__in', ['ENREVISION', 'CORTE', 'EMBALAJE', 'ENVIADO'])), name='estado_solicitud'),
        ),
    ]
