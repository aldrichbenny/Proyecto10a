# Generated by Django 5.1.6 on 2025-04-05 03:34
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hora_registro', models.TimeField(default=datetime.time(20, 34, 35, 361101))),
                ('fecha_entrega_estimada', models.DateField(default=django.utils.timezone.localdate)),
                ('estado_solicitud', models.CharField(choices=[('IN REVIEW', 'IN REVIEW'), ('PENDING', 'PENDING'), ('CUT-OFF', 'CUT-OFF'), ('PACKAGING', 'PACKAGING'), ('CUT-OFF-PENDING', 'CUT-OFF-PENDING'), ('CUT-OFF-ACCEPTED', 'CUT-OFF-ACCEPTED'), ('PACKAGING-PENDING', 'PACKAGING-PENDING'), ('PACKAGING-ACCEPTED', 'PACKAGING-ACCEPTED'), ('SHIPPED', 'SHIPPED'), ('CANCELLED', 'CANCELLED')], max_length=20)),
            ],
            options={
                'db_table': 'solicitud',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado_pedido', models.CharField(choices=[('IN REVIEW', 'IN REVIEW'), ('PENDING', 'PENDING'), ('CUT-OFF', 'CUT-OFF'), ('PACKAGING', 'PACKAGING'), ('CUT-OFF-PENDING', 'CUT-OFF-PENDING'), ('CUT-OFF-ACCEPTED', 'CUT-OFF-ACCEPTED'), ('PACKAGING-PENDING', 'PACKAGING-PENDING'), ('PACKAGING-ACCEPTED', 'PACKAGING-ACCEPTED'), ('SHIPPED', 'SHIPPED'), ('CANCELLED', 'CANCELLED')], max_length=20)),
                ('cantidad_total', models.IntegerField(default=0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hora_historial_stock', models.TimeField(default=datetime.time(20, 34, 35, 338904))),
                ('id_talla', models.ForeignKey(db_column='id_talla', on_delete=django.db.models.deletion.CASCADE, to='api.talla')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado_seguimiento', models.CharField(choices=[('IN REVIEW', 'IN REVIEW'), ('PENDING', 'PENDING'), ('CUT-OFF', 'CUT-OFF'), ('PACKAGING', 'PACKAGING'), ('CUT-OFF-PENDING', 'CUT-OFF-PENDING'), ('CUT-OFF-ACCEPTED', 'CUT-OFF-ACCEPTED'), ('PACKAGING-PENDING', 'PACKAGING-PENDING'), ('PACKAGING-ACCEPTED', 'PACKAGING-ACCEPTED'), ('SHIPPED', 'SHIPPED'), ('CANCELLED', 'CANCELLED')], max_length=20)),
                ('fecha', models.DateField(default=django.utils.timezone.localdate)),
                ('hora', models.TimeField(default=datetime.time(20, 34, 35, 364250))),
            ...
            options={
                ...
                'constraints': [models.CheckConstraint(condition=models.Q(('estado_seguimiento__in', ['IN REVIEW', 'PENDING', 'CUT-OFF', 'CUT-OFF-PENDING', 'CUT-OFF-ACCEPTED', 'PACKAGING', 'PACKAGING-PENDING', 'PACKAGING-ACCEPTED', 'SHIPPED', 'CANCELLED'])), name='historial_estado_solicitud')],
            },
        ),
