    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nombre_rol', models.SmallIntegerField(choices=[(1, 'Cliente'), (2, 'JefedeArea'), (3, 'Administrador')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pregunta1', models.SmallIntegerField(choices=[(1, '¿Donde naciste?'), (2, '¿Año que naciste?'), (3, '¿Nombre de un familiar?'), (4, '¿Color favorito?'), (5, '¿Numero favorito?'), (6, '¿Que edad tuviste en el 2010?')])),
                ('respuesta1', models.CharField(max_length=50)),
                ('pregunta2', models.SmallIntegerField(choices=[(1, '¿Donde naciste?'), (2, '¿Año que naciste?'), (3, '¿Nombre de un familiar?'), (4, '¿Color favorito?'), (5, '¿Numero favorito?'), (6, '¿Que edad tuviste en el 2010?')])),
                ('respuesta2', models.CharField(max_length=50)),
                ('pregunta3', models.SmallIntegerField(choices=[(1, '¿Donde naciste?'), (2, '¿Año que naciste?'), (3, '¿Nombre de un familiar?'), (4, '¿Color favorito?'), (5, '¿Numero favorito?'), (6, '¿Que edad tuviste en el 2010?')])),
